...
public:
    ...
    void checkCollision(Circle &other)
    {
        ...
        if ((dx * dx) + (dy * dy) <= radii * radii)
        {
            ...
            if (other.centerX - other.radius < 0)
                other.centerX = other.radius;
            if (other.centerX + other.radius > WINDOW_WIDTH)
                other.centerX = WINDOW_WIDTH - other.radius;
            if (other.centerY - other.radius < 0)
                other.centerY = other.radius;
            if (other.centerY + other.radius > WINDOW_HEIGHT)
                other.centerY = WINDOW_HEIGHT - other.radius;
        }
    }
